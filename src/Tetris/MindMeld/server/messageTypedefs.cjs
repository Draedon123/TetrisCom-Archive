...
/** @typedef { RoomConnectClientMessage | ReadyClientMessage | TransformLivePieceMessage | LockPieceMessage | HoldPieceMessage | UpdateUsernameClientMessage | GetRoomsClientMessage } ClientMessage */
...
/** @typedef { StartGameServerMessage | SetSeedServerMessage | TransformLivePieceMessage | LockPieceMessage | HoldPieceMessage | SetUsernameResponseServerMessage | RoomListServerMessage | RoomConnectResponseServerMessage } ServerMessage */
...
/** @typedef { { type: "lockPiece", lockNumber: number } } LockPieceMessage */
/** @typedef { { type: "hold" } } HoldPieceMessage */
